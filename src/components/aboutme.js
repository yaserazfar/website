...
Overall, I am looking to explore and go deeper into the many fields of software development to increase my knowledge to be able to have an impact in the world.
                            ...
                            <p> Java | C# | Python | C++ | React | JavaScript | SQL </p>
                        </div>
                    </Cell>
                </Grid>
            </div>
